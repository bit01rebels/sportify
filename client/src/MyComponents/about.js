...
export default function about() {
  return (
    <>
      <div className={classes.marginCorrection}>
      <div className="container  mb-4 ms-auto me-auto">
        <div className="container mb-4 ms-auto me-auto">
          <h1 className="fs-1 mb-4  ">Vision and Mission</h1>
      ...
      <div className={classes.wrap}>
        <div className="row mt-4 mb-4 ms-auto me-auto">
          <div className="row mt-4 mb-4 ms-auto me-auto">
            ...
            <div className="container-md col-lg">
              <div className="card ms-auto me-auto mt-4">
                <img
                  src={jayesh_image}
                  className={classes.image}
                  alt="JayeshImage"
